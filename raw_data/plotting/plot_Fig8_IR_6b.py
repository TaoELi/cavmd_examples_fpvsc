...
def plot_IR_all():
    ...
    E0 = "5e-5"
    paths = ["../co2_liquid_phase/E0_1.225e-4_6b_singlemode", "../co2_liquid_phase/E0_1.225e-4_6b"]
    ...
    axes[0].text(1910, 1.1, "single-mode cavity\n6 CO$_2$ subsystems",fontsize=11, color=colors[1])
    axes[0].text(1910, 2.1, "36-mode cavity\n6 CO$_2$ subsystems",fontsize=11, color=colors[2])
    ...
    N = 36
    E0 = "1.225e-4"
    freq, sp = obtain_spectrum(path="../co2_liquid_phase/E0_%s_6b" %E0, n=36)
    ...
    clp.adjust(savefile="IR_CO2_6b.pdf")
