...
def plot_IR_all():
    ...
    E0 = "5e-5"
    paths = ["../co2_liquid_phase/E0_5e-5_point_singlemode", "../co2_liquid_phase/E0_5e-5_point"]
    ...
    axes[0].text(1910, 0.1, "liquid CO$_2$\noutside cavity", fontsize=10, color=colors[0])
    axes[0].text(1910, 1.1, "single-mode cavity\n36 CO$_2$ subsystems",fontsize=10, color=colors[1])
    axes[0].text(1910, 1.8, "36-mode cavity\n\n\n36 CO$_2$ subsystems",fontsize=10, color=colors[2])
    ...
    N = 36
    E0 = "5e-5"
    freq, sp = obtain_spectrum(path="../co2_liquid_phase/E0_%s_point" %E0, n=36)
    ...
    axes[1].text(1250, 2550, "cavity photon", color='g', fontsize=12)
    ...
    clp.adjust(savefile="IR_CO2_extreme.pdf")
