...
def plot_IR_all():
    ...
    E0 = "5e-5"
    paths = ["../co2_liquid_phase/E0_%s_singlemode" %E0, "../co2_liquid_phase/E0_%s_108modes" %E0]
    ...
    N = 108
    E0 = "5e-5"
    freq, sp = obtain_spectrum(path="../co2_liquid_phase/E0_%s_108modes" %E0, n=N)
    ...
    sp /= np.max(np.max(sp)) 
    sp = sp[::-1, :]
    freq_cav_min = (2320.0**2 + 16.67**2)**0.5
    freq_cav_max = (2320.0**2 + (16.67*N)**2)**0.5
    freq_cav_inplane_min = 16.67
    freq_cav_inplane_max = 16.67 * N
    ...
    axes[1].text(1026, 2484, "cavity photon", color='g', fontsize=12)
    axes[1].text(1000, 2275, "C=O asym. stretch", color='w', fontsize=12)
    ...
    clp.adjust(savefile="IR_CO2_108modes.pdf")
